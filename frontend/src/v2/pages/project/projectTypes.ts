...
export type {
  Nomenclature, Department, ProjectSettings, Task, AssetRef, Membership as Member,
  SequenceSummary as Sequence, ShotSummary as Shot, Asset,
} from '../../types/api';
...
export const ASSET_TYPES: readonly AssetType[] = ['CHARACTER', 'PROP', 'ENVIRONMENT', 'VEHICLE', 'FX', 'OTHER'];
export const TASK_TYPES: readonly TaskType[] = ['ANIMATION', 'FX', 'COMPOSITING', 'LIGHTING', 'MODELING', 'RIGGING', 'LOOKDEV', 'LAYOUT', 'OTHER'];
