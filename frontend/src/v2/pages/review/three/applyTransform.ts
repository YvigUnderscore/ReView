 ...
 *
 * Le pivot est l'origine, donc le **point d'appui au sol** du modèle normalisé : le yaw le fait
 * tourner sur place et l'échelle le fait grandir sans le faire traverser la grille.
 */
