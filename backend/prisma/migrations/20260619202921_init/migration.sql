...
-- CreateEnum
CREATE TYPE "MediaKind" AS ENUM ('VIDEO', 'IMAGE', 'MODEL_3D', 'SPLAT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Board_versionId_key" ON "Board"("versionId");
...
-- AddForeignKey
ALTER TABLE "Board" ADD CONSTRAINT "Board_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "Version"("id") ON DELETE CASCADE ON UPDATE CASCADE;
